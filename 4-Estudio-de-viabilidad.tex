...
\coloredUnderline{\href{https://www.ea.com/es-es/games/ea-sports-fc}{EA Sports FC}} constituye una destacada franquicia de videojuegos de fútbol, los cuales se encuentran disponibles en diversas plataformas. 
En  el juego \coloredUnderline{\href{https://www.ea.com/es-es/games/fifa/fifa-23/ultimate-team/item-guide}{FIFA Ultimate Team}} los usuarios tienen la oportunidad de adquirir sobres que contienen cartas de futbolistas y otros elementos complementarios. 
Además, cuentan con acceso a un mercado virtual donde pueden llevar a cabo transferencias de jugadores mediante un sistema de subastas.

El sistema de coleccionismo de cartas puede variar según la plataforma del juego, sin embargo, todos comparten una serie de características comunes, como la posibilidad de pujar por un jugador, establecer un precio de compra directa y vender jugadores propios. 
Además, incluyen distintas rarezas de cartas y eventos especiales.

En las siguientes figuras, se muestra la interfaz de usuario de \coloredUnderline{\href{https://apps.apple.com/es/app/ea-sports-fc-24-companion/id1127108818}{EA SPORTS FC™ 24 Companion}}. Esta aplicación permite a los usuarios gestionar su club de FIFA Ultimate Team desde sus dispositivos móviles.
\begin{figure}[H]
    \centering
...
MySQL es un sistema de gestión de bases de datos relacional de código abierto, ampliamente utilizado en aplicaciones web. Se destaca por su rendimiento, escalabilidad y fiabilidad.

Entre sus ventajas, destacan su amplia adopción, su compatibilidad con múltiples plataformas y su soporte para transacciones ACID.
Sin embargo, MySQL puede no ser la opción más adecuada para aplicaciones que requieren una alta disponibilidad y escalabilidad horizontal, ya que su arquitectura monolítica puede limitar su capacidad de adaptación a cargas de trabajo variables.
...
Entre sus ventajas, destacan su escalabilidad horizontal, su capacidad para manejar datos no estructurados y su rendimiento en operaciones de lectura y escritura.
...
\subsubsubsection{Firebase}
Firebase es una plataforma de desarrollo de aplicaciones móviles y web, propiedad de Google, que ofrece una base de datos en tiempo real y una amplia gama de servicios en la nube.

Entre sus ventajas, destacan su facilidad de uso, su integración con otras herramientas de Google y su capacidad para manejar aplicaciones en tiempo real.
Sin embargo, Firebase puede no ser la opción más adecuada para aplicaciones que requieren una alta personalización y control sobre la base de datos, ya que su modelo de datos basado en documentos puede limitar la flexibilidad en ciertos escenarios.
...
De esta manera, con todas decisiones anteriores se obtiene una arquitectura MERN (MongoDB, Express, React, Node.js) que se adapta de manera óptima a las necesidades del sistema a desarrollar.
