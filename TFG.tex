...
% Comando para dar estilo a los links
\newcommand{\refLink}[1]{\textcolor{darkgreen}{\uline{\nameref{#1}}}}
...
\end{tikzpicture}
\newpage
\input{5-Planificacion-Gestion-TFG}
...
\input{6-Analisis-del-sistema-de-informacion}
