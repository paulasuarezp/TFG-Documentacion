...
\usepackage{caption}
\usepackage{longtable} %Permite que las tablas puedan ocupar más de una página
\usepackage{array}         % Mejoras en las presentaciones de las tablas
\usepackage{pdflscape}
\captionsetup{hypcap=true}  % Asegura que los links apunten a la parte superior de la figura
...
\fancypagestyle{plain}{
    ...
    \fancyfoot[C]{\scriptsize Plataforma de coleccionismo de cartas digitales. \\ Trabajo Fin de Grado Ingeniería Informática del Software \textbar{} Versión 0.1 \\ Paula Suárez Prieto}
...
\titleformat{\chapter}[display]
  ...
  {\color{darkgreen}\chaptertitlename\ \thechapter}{10pt}{\Huge\color{black}\raggedright}
...
% Establecer la sangría del párrafo
\setlength{\parindent}{15pt} % Valor típico

% Establecer el espacio entre párrafos
\setlength{\parskip}{6pt plus 2pt minus 1pt} % puede ajustar el espacio entre los párrafos de 5pt a 8pt según las necesidades del formato de la página
...
\end{tikzpicture}
\newpage
\input{4-Arquitectura-tecnologica}
...
\end{tikzpicture}
\newpage
\input{5-Planificacion-Gestion-TFG.tex}

\newpage
\chapter{ANÁLISIS y DISEÑO DEL SISTEMA DE INFORMACIÓN}
\noindent\begin{tikzpicture}
% Definir el degradado
\shade[left color=darkgreen, right color=lightgreen] (0,0) rectangle (\textwidth-1pt,0.2);
...
\input{6-Analisis-diseno-del-sistema-de-informacion.tex}
...
\input{7-Construccion-sistema-informacion.tex}
...
\end{tikzpicture}
\newpage
\input{8-Conclusiones-amplicaciones.tex}
